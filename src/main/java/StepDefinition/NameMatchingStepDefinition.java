...
public class NameMatchingStepDefinition {
	...
	@Then("User deletes Name Matching record using {string}")
	public void user_deletes_Name_Matching_record_using(String SheetName) throws InvalidFormatException, InterruptedException, IOException {
		nameMatchingPage.deleteNameMatchingRecord(SheetName);
	}
